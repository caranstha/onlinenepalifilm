...
<script type="text/javascript" src="{{url('lib/js/jquery1.min.js')}}"></script>
<!-- start-smoth-scrolling -->
</head>
	...
	<div class="header">
		<div class="container">
			<div class="w3layouts_logo">
				<a href="index.html"><h1>Online Nepali<span>Movies</span></h1></a>
			</div>
			<div class="w3_search">
			...
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				...
				<div id="myTabContent" class="tab-content">
					...
					<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
						...
						<div class="col-md-2 w3l-movie-gride-agile">
							<a href="{{url('user/singlepage')}}/{{$row->id}}" class="hvr-shutter-out-horizontal"><img src="{{url('images/m22.jpg')}}" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="{{url('user/singlepage')}}/{{$row->id}}">Assassin's Creed 3</a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
									<p>2016</p>
									<div class="block-stars">
						...
						<div class="col-md-2 w3l-movie-gride-agile">
							<a href="{{url('user/singlepage')}}/{{$row->id}}" class="hvr-shutter-out-horizontal"><img src="{{url('images/m2.jpg')}}" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="{{url('user/singlepage')}}/{{$row->id}}">Bad Moms</a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
									<p>2016</p>
									<div class="block-stars">
						...
						<div class="col-md-2 w3l-movie-gride-agile">
							<a href="{{url('user/singlepage')}}/{{$row->id}}" class="hvr-shutter-out-horizontal"><img src="{{url('images/m9.jpg')}}" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="{{url('user/singlepage')}}/{{$row->id}}">Central Intelligence</a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
									<p>2016</p>
									<div class="block-stars">
...
<!-- Latest-tv-series -->
	<div class="Latest-tv-series">
		...
		<div class="container">
			...
			<!-- flexSlider -->
				<link rel="stylesheet" href="{{url('lib1/css/flexslider.css')}}" type="text/css" media="screen" property="" />
		...
		<div class="container">
			<div class="w3ls_footer_grid">
				...
				<div class="col-md-6 w3ls_footer_grid_right">
					<a href="index.html"><h2>Online Nepali<span>Movies</span></h2></a>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="col-md-5 w3ls_footer_grid1_left">
				<p>&copy; 2016 Oneline Nepali Movies. All rights reserved | Design by <a href="http://facebook.com/sthacaran">Caran Shrestha</a></p>
			</div>
